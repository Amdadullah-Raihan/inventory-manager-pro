...
const AddProductDetails = () => {
  ...
  return (
    <form
      ...
      className="py-4 border-b dark:border-b-gray-500"
    >
      <Toaster />
      ...
      <div className="w-full h-full">
        {invoice?.productDetails?.products &&
          invoice.productDetails.products.map((product, idx) => (
            <div
              key={idx}
              className="flex gap-1 mb-2 border-b lg:items-center border-b-secondary lg:mb-0 lg:border-none "
            >
              ...
              <div className="relative grid grid-cols-2 gap-2 mb-2 lg:grid-cols-4 ">
                ...
                <input
                  ...
                  value={
                    invoice.productDetails.products[idx].quantity === 0
                      ? ""
                      : invoice.productDetails.products[idx].quantity
                  }
                ...
                <input
                  ...
                  value={
                    invoice.productDetails.products[idx].unitPrice === 0
                      ? ""
                      : invoice.productDetails.products[idx].unitPrice
                  }
