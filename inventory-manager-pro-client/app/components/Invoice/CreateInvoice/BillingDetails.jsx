        ...
        <div className='flex flex-col-reverse lg:flex-row lg:justify-between gap-6  py-2 dark:text-gray-400          '>
            ...
            <div className="w-full text-gray-500 dark:text-gray-400          ">
                <div className='mb-[150px]'>
                    <h4 className='text-gray-700 mb-2 dark:text-gray-400          '>Billing&apos;s Details</h4>
                ...
                <div>
                    <p className='inline border-t text-gray-500 dark:text-gray-400          '>Sales Person&apos;s Signature</p>
                </div>
            </div>
            ...
            <div className='w-full text-gray-500 dark:text-gray-400          '>
                ...
                <div className='mt-[93px] '>
                    ...
                    <div className='flex  justify-end lg:justify-between border-t'>
                        <p>Total In Words</p>
                        <p className='flex items-center text-gray-700 dark:text-gray-400          '><TbCurrencyTaka /></p>
                    </div>
                </div>
