...
const InvoicePreview = ({ invoice, isLoading }) => {
    ...
    return (
        <div className='w-full overflow-hidden bg-[#F7F7F9] min-h-screen p-2 lg:p-6'>
            {
                isLoading ? <div className=' flex justify-center py-16 gap-1 text-primary'>
                    ...
                    invoice.customerDetails ?
                        ...
                        <div className='bg-white p-2 lg:p-6 rounded-lg max-w-[790px] mx-auto overflow-hidden'>
