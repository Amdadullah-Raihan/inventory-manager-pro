...
const UpdateProduct = () => {
    ...
    const handleUpdateProduct = (e) => {
        ...
        axios.put(`${apiUrl}/api/products/update/${productId}`, product)
            .then((response) => {
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className="bg-white dark:bg-neutral dark:text-gray-400   shadow lg:p-6 p-2 rounded-lg max-w-[900px] mx-auto"
                >
                    ...
                    <div className='mt-6'>
                        ...
                        <div className='grid lg:grid-cols-2 gap-4'>
                            ...
                            <div>
                                ...
                                <button type='submit' className='btn  border-none w-full bg-[#5A66F1] text-white  hover:bg-secondary'><TbShoppingBagEdit className='text-lg' />Update Product</button>
